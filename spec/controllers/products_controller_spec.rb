...
describe ProductsController do
  ...
  describe "POST #create" do
    ...
    it "does not save a product with invalid attributes" do
      to_match_product = FactoryGirl.build(:product)
      post :create, product: FactoryGirl.attributes_for(:product, :product_name => "")
  ...
  describe "PUT #update" do
    it "updates a product with valid attributes" do
      ...
      put :update, :id => saved_product.id, product: FactoryGirl.attributes_for(:product, :product_name => "Updated Name")
      expect(assigns(:product).product_name).to eq("Updated Name")
    end

    it "does not update a product with invalid attributes" do
      saved_product = FactoryGirl.create(:product)
      put :update, :id => saved_product.id, product: FactoryGirl.attributes_for(:product, :product_name => "")
