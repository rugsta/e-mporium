...
describe CartsController do
  ...
  describe 'POST #create' do
    ...
    it 'generates and activation code if one does not exist' do
      ...
      post :add_to_cart, :id => Product_to_add_to_cart.id
    ...
    it 'generates a cart if required' do
      ...
      post :add_to_cart, :id => Product_to_add_to_cart_1.id
    ...
    it 'does not generate a cart if one already exists' do
      ...
      post :add_to_cart, :id => Product_to_add_to_cart_2.id
      post :add_to_cart, :id => Product_to_add_to_cart_3.id
    ...
    it 'generates cart line items' do
      ...
      post :add_to_cart, :id => Product_to_add_to_cart_4.id
      post :add_to_cart, :id => Product_to_add_to_cart_4.id
